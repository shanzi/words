...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Picture.uploaded_at'
        db.alter_column('pictures_picture', 'uploaded_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'Picture.uploaded_at'
        db.alter_column('pictures_picture', 'uploaded_at', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
