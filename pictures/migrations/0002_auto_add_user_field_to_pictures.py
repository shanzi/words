...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pictures_picture', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='pictures', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Picture.user'
        db.delete_column('pictures_picture', 'user_id')
