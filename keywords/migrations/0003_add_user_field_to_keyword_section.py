...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'KeywordSection.user'
        db.add_column('keywords_keywordsection', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='sections', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'KeywordSection.user'
        db.delete_column('keywords_keywordsection', 'user_id')
    ...
    models = {
        ...
        'keywords.keywordsection': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sections'", 'to': "orm['auth.User']"})
        }
    }
